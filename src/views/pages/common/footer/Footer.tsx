                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2'>
                        ...
                        <div className='mb-5'>
                            ...
                            <div className="text-center text-xl text-white pt-7 ">
                                <a href="/#" className="w-10 h-10 rounded-full bg-yellow-500 hover:bg-yellow-600 mx-1 inline-block pt-1"><i className="fab fa-twitter"></i></a>
                                <a href="/#" className="w-10 h-10 rounded-full bg-yellow-500 hover:bg-yellow-600 mx-1 inline-block pt-1"><i className="fab fa-instagram"></i></a>
                                <a href="/#" className="w-10 h-10 rounded-full bg-yellow-500 hover:bg-yellow-600 mx-1 inline-block pt-1"><i className="fab fa-facebook"></i></a>
                                <a href="/#" className="w-10 h-10 rounded-full bg-yellow-500 hover:bg-yellow-600 mx-1 inline-block pt-1"><i className="fab fa-linkedin"></i></a>
